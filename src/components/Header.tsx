      ...
      <div className="flex flex-col lg:flex-row gap-[18px] lg:gap-[28px] lg:pl-[48px]">
        ...
        <div className="flex flex-col gap-[12px] text-start mt-0 lg:mt-[24px] px-[16px]">
          ...
          <div className="flex flex-wrap gap-2 items-center justify-center">
            <a href="">Resume</a> | <a href="https://www.linkedin.com/in/oluwatobi-adebola/" target="_blank">LinkedIn</a> | <a href="https://github.com/sleekidd" target="_blank">Github</a> | <a href="https://dribbble.com/thetobiallen" target="_blank">Dribbble</a> | <a href="https://x.com/thetobiallen" target="_blank">X (Twitter)</a> | <a href="https://www.instagram.com/sleekidd/" target="_blank">Instagram</a> | <a href="">Contact</a></div>
        </div>
      </div>
    </div>
